...
$(document).ready(function() {
    ...
    $(".toggle-subnav").click(function(e) {
        e.preventDefault();
        var $el = $(this);
        $el.parents(".subnav").toggleClass("subnav-hidden");
        $el.parents(".subnav-title").next('.subnav-menu,.subnav-content').slideToggle("fast");
        $el.find("i").toggleClass("fa-angle-down").toggleClass("fa-angle-right");
