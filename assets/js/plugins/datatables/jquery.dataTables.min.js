...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Prvi",sLast:"Poslednji",sNext:"Sledeća",sPrevious:"Prethodna"},
sEmptyTable:"Nema podataka za prikazivanje",sInfo:"Prikaz _START_ do _END_ od ukupno _TOTAL_ stavki",sInfoEmpty:"Prikaz 0 do 0 od ukupno 0 stavki",sInfoFiltered:"(filtrirano od ukupno _MAX_ stavki)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Prikaz _MENU_ stavki",sLoadingRecords:"Učitavam...",sProcessing:"Obrađujem...",sSearch:"Pretraži:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nema rezultata pretrage"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,
