...
(function(a) {
    ...
    mc.DDDD = g(mc.DDD, 3), l(i.prototype, {
        ...
        _months: "Januar_Februar_Mart_April_Maj_Jun_Jul_Avgust_Septembar_Oktobar_Novembar_Decembar".split("_"),
        months: function(a) {
            return this._months[a.month()]
        },
        _monthsShort: "Jan_Feb_Mar_Apr_Maj_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
        ...
        _weekdays: "Nedelja_Ponedeljak_Utorak_Sreda_Četvrtak_Petak_Subota".split("_"),
        weekdays: function(a) {
            return this._weekdays[a.day()]
        },
        _weekdaysShort: "Ned_Pon_Uto_Sre_Čet_Pet_Sub".split("_"),
        weekdaysShort: function(a) {
            return this._weekdaysShort[a.day()]
        },
        _weekdaysMin: "Ne_Po_Ut_Sr_Če_Pe_Su".split("_"),
        ...
        return rb.isDuration(a) ? g = {
            ...
            s: e(h[7]),
            w: e(h[8])
        }) : "object" == typeof g && ("od" in g || "to" in g) && (f = q(rb(g.from), rb(g.to)), g = {}, g.ms = f.milliseconds, g.M = f.months), d = new k(g), rb.isDuration(a) && a.hasOwnProperty("_locale") && (d._locale = a._locale), d
