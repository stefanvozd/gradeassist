    ...
    window.elFinder = function(b, c) {
            ...
            var d = this,
                ...
                E = function(a) {
                    ...
                    while (b--) {
                        c = a[b];
                        if (c.name && c.hash && c.mime) {
                            if (!c.phash) {
                                var e = "volume_" + c.name,
                                    f = d.i18n(e);
                                e != f && (c.i18 = f)
                            }
                            r[c.hash] = c
                ...
                F = function(b) {
                    ...
                    }), c == 9 && !a(b.target).is(":input") && b.preventDefault())
                },
                G = new Date,
                H, I;
            this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = navigator.userAgent.indexOf("Mac") !== -1 ? "mac" : navigator.userAgent.indexOf("Win") !== -1 ? "win" : "other", this.UA = function() {
                var a = !document.uniqueID && !window.opera && !window.sidebar && window.localStorage && typeof window.orientation == "undefined";
                return {
                    ...
                    Opera: window.opera,
                    Webkit: a,
                    Chrome: a && window.chrome,
                    Safari: a && !window.chrome,
            ...
            }(), this.viewType = this.storage("view") || this.options.defaultView || "icons", this.sortType = this.storage("sortType") || this.options.sortType || "name", this.sortOrder = this.storage("sortOrder") || this.options.sortOrder || "asc", this.sortStickFolders = this.storage("sortStickFolders"), this.sortStickFolders === null ? this.sortStickFolders = !!this.options.sortStickFolders : this.sortStickFolders = !!this.sortStickFolders, this.sortRules = a.extend(!0, {}, this._sortRules, this.options.sortsRules), a.each(this.sortRules, function(a, b) {
                typeof b != "function" && delete d.sortRules[a]
            }), this.compare = a.proxy(this.compare, this), this.notifyDelay = this.options.notifyDelay > 0 ? parseInt(this.options.notifyDelay) : 500, this.draggable = {
                appendTo: "body",
                addClasses: !0,
                delay: 30,
                revert: !0,
                ...
                drag: function(a, b) {
                    b.helper.data("locked") || b.helper.toggleClass("elfinder-drag-helper-plus", a.shiftKey || a.ctrlKey || a.metaKey)
                },
                start: function(b, c) {
                    var d = a.map(c.helper.data("files") || [], function(a) {
                            return a || null
                        }),
                        e, f;
                    e = d.length;
                    while (e--) {
                        f = d[e];
                        if (r[f].locked) {
                            c.helper.addClass("elfinder-drag-helper-plus").data("locked", !0);
                            break
                        }
                    }
                },
                ...
                helper: function(b, c) {
                    ...
                    return d.trigger("dragstart", {
                        target: e[0],
                        originalEvent: b
                    }), h = e.is("." + d.res("class", "cwdfile")) ? d.selected() : [d.navId2Hash(e.attr("id"))], f.append(g(r[h[0]].mime)).data("files", h).data("locked", !1), (i = h.length) > 1 && f.append(g(r[h[i - 1]].mime) + '<span class="elfinder-drag-num">' + i + "</span>"), f
                }
            }, this.droppable = {
                tolerance: "pointer",
                ...
                drop: function(b, c) {
                    ...
                    g.length && (c.helper.hide(), d.clipboard(g, !(b.ctrlKey || b.shiftKey || b.metaKey || c.helper.data("locked"))), d.exec("paste", j), d.trigger("drop", {
                        files: f
                    }))
                }
                ...
                return b
            }, this.path2array = function(a, b) {
                var c, d = [];
                while (a && (c = r[a]) && c.hash) d.unshift(b && c.i18 ? c.i18 : c.name), a = c.phash;
                return d
            }, this.path = function(a, b) {
                return r[a] && r[a].path ? r[a].path : this.path2array(a, b).join(q.separator)
            }, this.url = function(b) {
                var c = r[b];
                if (!c || !c.read) return "";
                c.url == "1" && this.request({
                    data: {
                        cmd: "url",
                        target: b
                    },
                ...
                var b = r[a],
                    c = b && b.tmb && b.tmb != 1 ? q.tmbUrl + b.tmb : "";
                return c && (this.UA.Opera || this.UA.IE) && (c += "?_=" + (new Date).getTime()), c
            }, this.selected = function() {
                return s.slice(0)
            }, this.selectedFiles = function() {
                return a.map(s, function(b) {
                    return r[b] ? a.extend({}, r[b]) : null
                })
                ...
                var c = this,
                    ...
                    p = function(b) {
                        ...
                        b = c.normalize(b), c.api || (c.api = b.api || 1, c.newAPI = c.api >= 2, c.oldAPI = !c.newAPI), b.options && (q = a.extend({}, q, b.options)), b.netDrivers && (c.netDrivers = b.netDrivers), e.resolve(b), b.debug && c.debug("backend-debug", b.debug)
                    },
                    r, s;
                ...
                if (g == "open")
                    while (s = x.pop()) s.state() == "pending" && (s.quiet = !0, s.abort());
                ...
                var b = this,
                    ...
                    e = {
                        data: {
                            cmd: "tree",
                            target: p == this.root() ? p : this.file(p).phash
                        },
                        preventDefault: !0
                    };
                return a.when(this.request(d), this.request(e)).fail(function(a) {
                    ...
                    return e.added.push(a.cwd), e.removed.length && b.remove(e), e.added.length && b.add(e), e.changed.length && b.change(e), c.resolve(e)
                }), c
            ...
            a.extend(a.ui.keyCode, {
                ...
                cwd: a("<div/>").appendTo(b).elfindercwd(this, this.options.uiOptions.cwd || {}),
                notify: this.dialog("", {
            ...
            i18: {
                ...
                daysShort: ["Sun", "Mon", "Tue", "131Wed", "Thu", "Fri", "Sat"]
            },
            kinds: {
                unknown: "Unknown",
                directory: "Folder",
            ...
            iframeCnt: 0,
            uploads: {
                checkFile: function(b) {
                    if (b.type == "files") return b.files;
                    var c = [],
                        d, e = b.files[0];
                    if (b.type == "html") {
                        d = /<img[^>]+src=["']?([^"'> ]+)/ig;
                        var f = [],
                            g = "",
                            h;
                        while (f = d.exec(e)) g = f[1].replace(/&amp;/g, "&"), g.match(/^http/) && a.inArray(g, c) == -1 && c.push(g);
                        h = e.match(/<\/a>/i);
                        if (h && h.length == 1) {
                            d = /<a[^>]+href=["']?([^"'> ]+)((?:.|\s)+)<\/a>/i;
                            if (f = d.exec(e)) f[2].match(/<img/i) || (g = f[1].replace(/&amp;/g, "&"), g.match(/^http/) && a.inArray(g, c) == -1 && c.push(g))
                        }
                    } else {
                        d = /(http[^<>"{}|\\^\[\]`\s]+)/ig;
                        while (f = d.exec(e)) g = f[1].replace(/&amp;/g, "&"), a.inArray(g, c) == -1 && c.push(g)
                    }
                    return c
                },
                iframe: function(b, c) {
                    var d = c ? c : this,
                        e = b.input ? b.input : !1,
                        f = e ? !1 : d.uploads.checkFile(b),
                        g = a.Deferred().fail(function(a) {
                            a && d.error(a)
                        }).done(function(a) {
                            a.warning && d.error(a.warning), a.removed && d.remove(a), a.added && d.add(a), a.changed && d.change(a), d.trigger("upload", a), a.sync && d.sync()
                        }),
                        h = "iframe-" + d.namespace + ++d.iframeCnt,
                        i = a('<form action="' + d.uploadURL + '" method="post" enctype="multipart/form-data" encoding="multipart/form-data" target="' + h + '" style="display:none"><input type="hidden" name="cmd" value="upload" /></form>'),
                        j = this.UA.IE,
                        k = function() {
                            p && clearTimeout(p), o && clearTimeout(o), n && d.notify({
                                type: "upload",
                                cnt: -m
                            }), setTimeout(function() {
                                j && a('<iframe src="javascript:false;"/>').appendTo(i), i.remove(), l.remove()
                            }, 100)
                        },
                        l = a('<iframe src="' + (j ? "javascript:false;" : "about:blank") + '" name="' + h + '" style="position:absolute;left:-1000px;top:-1000px" />').bind("load", function() {
                            l.unbind("load").bind("load", function() {
                                var a = d.parseUploadData(l.contents().text());
                                k(), a.error ? g.reject(a.error) : g.resolve(a)
                            }), o = setTimeout(function() {
                                n = !0, d.notify({
                                    type: "upload",
                                    cnt: m
                                })
                            }, d.options.notifyDelay), d.options.iframeTimeout > 0 && (p = setTimeout(function() {
                                k(), g.reject([errors.connect, errors.timeout])
                            }, d.options.iframeTimeout)), i.submit()
                        }),
                        m, n, o, p;
                    if (f && f.length) a.each(f, function(a, b) {
                        i.append('<input type="hidden" name="upload[]" value="' + b + '"/>')
                    }), m = 1;
                    else {
                        if (!(e && a(e).is(":file") && a(e).val())) return g.reject();
                        i.append(e), m = e.files ? e.files.length : 1
                    }
                    return i.append('<input type="hidden" name="' + (d.newAPI ? "target" : "current") + '" value="' + d.cwd().hash + '"/>').append('<input type="hidden" name="html" value="1"/>').append(a(e).attr("name", "upload[]")), a.each(d.options.onlyMimes || [], function(a, b) {
                        i.append('<input type="hidden" name="mimes[]" value="' + b + '"/>')
                    }), a.each(d.options.customData, function(a, b) {
                        i.append('<input type="hidden" name="' + a + '" value="' + b + '"/>')
                    }), i.appendTo("body"), l.appendTo("body"), g
                },
                xhr: function(b, c) {
                    var d = c ? c : this,
                        ...
                        g = new FormData,
                        h = b.input ? b.input.files : d.uploads.checkFile(b),
                        i = h.length,
                        j = 5,
                        k = !1,
                        l = function() {
            ...
            localStorage: function(a, b) {
                ...
                a = "elfinder-" + a + this.id;
                if (b === null) return console.log("remove", a), c.removeItem(a);
                if (b !== void 0) try {
                    c.setItem(a, b)
                } catch (d) {
                    c.clear(), c.setItem(a, b)
                }
                return c.getItem(a)
            },
            cookie: function(b, c) {
            ...
            setSort: function(a, b, c) {
                this.storage("sortType", this.sortType = this.sortRules[a] ? a : "name"), this.storage("sortOrder", this.sortOrder = /asc|desc/.test(b) ? b : "asc"), this.storage("sortStickFolders", (this.sortStickFolders = !!c) ? 1 : ""), this.trigger("sortchange")
            },
            _sortRules: {
                name: function(a, b) {
            ...
            compare: function(a, b) {
                ...
                return k = e ? h(a, b) : h(b, a), d != "name" && k == 0 ? k = e ? g.name(a, b) : g.name(b, a) : k
            },
            ...
            confirm: function(b) {
                var c = !1,
                    ...
                    f, g;
                return b
                    .reject && (d.buttons[this.i18n(b.reject.label)] = function() {
            ...
            formatSize: function(a) {
                var b = 1,
                    c = "b";
                return a == "unknown" ? this.i18n("unknown") : (a > 1073741824 ? (b = 1073741824, c = "GB") : a > 1048576 ? (b = 1048576, c = "MB") : a > 1024 && (b = 1024, c = "KB"), a /= b, (a > 0 ? b >= 1048576 ? a.toFixed(2) : Math.round(a) : 0) + " " + c)
            },
        ...
        }, elFinder.prototype.version = "2.x_n (Nightly: 7f49dcc)", a.fn.elfinder = function(a) {
            ...
            lang: "en",
            cssClass: "",
            commands: ["open", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkdir", "mkfile", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "help", "resize", "sort", "netmount", "netunmount", "pixlr"],
            commandsOptions: {
                getfile: {
                    onlyURL: !1,
                    multiple: !1,
                ...
                netmount: {
                    ftp: {
                        inputs: {
                            host: a('<input type="text"/>'),
                            port: a('<input type="text"/>'),
                            path: a('<input type="text" value="/"/>'),
                            user: a('<input type="text"/>'),
                            pass: a('<input type="password"/>')
                        }
                    },
                    dropbox: {
                        inputs: {
                            host: a('<span id="elfinder-cmd-netmout-dropbox-host"><span class="elfinder-info-spinner"/></span></span><input type="hidden" value="dropbox"/>'),
                            path: a('<input type="text" value="/"/>'),
                            user: a('<input id="elfinder-cmd-netmout-dropbox-user" type="hidden"/>'),
                            pass: a('<input id="elfinder-cmd-netmout-dropbox-pass" type="hidden"/>')
                        },
                        select: function(b) {
                            a("#elfinder-cmd-netmout-dropbox-host").find("span").length && b.request({
                                data: {
                                    cmd: "netmount",
                                    protocol: "dropbox",
                                    host: "dropbox.com",
                                ...
                                a("#elfinder-cmd-netmout-dropbox-host").html(c.body.replace(/\{msg:([^}]+)\}/g, function(a, c) {
                                    return b.i18n(c, "Dropbox.com")
                                }))
                            }).fail(function() {})
                        }
                    }
            ...
            this.fm = b, this.name = "", this.title = "", this.state = -1, this.alwaysEnabled = !1, this._disabled = !1, this.disableOnSearch = !1, this.updateOnSelect = !0,
                this._handlers = {
                    enable: function() {
            ...
            mixin: {
                make: function() {
                    var b = this.fm,
                        ...
                        d = b.getUI("cwd"),
                        e = a.Deferred().fail(function(a) {
                            d.trigger("unselectall"), a && b.error(a)
                        }).always(function() {
            ...
            return this.each(function() {
                ...
                a.isArray(b.variants) && (k.addClass("elfinder-menubutton"), j = a('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>').hide().appendTo(k).zIndex(12 + k.zIndex()).delegate("." + h, "mouseenter mouseleave", function() {
            ...
            return this.each(function() {
                var c = a(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + b.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "mouseenter mouseleave", function() {
            ...
            return this.not(".elfinder-cwd").each(function() {
                var d = b.viewType == "list",
                    e = "undefined",
                    f = "select." + b.namespace,
                    g = "unselect." + b.namespace,
                    h = "disable." + b.namespace,
                    i = "enable." + b.namespace,
                    j = "class",
                    k = b.res(j, "cwdfile"),
                    l = "." + k,
                    m = "ui-selected",
                    ...
                    p = b.res(j, "droppable"),
                    q = b.res(j, "hover"),
                    r = b.res(j, "adroppable"),
                    s = k + "-tmp",
                    t = b.options.loadTmbs > 0 ? b.options.loadTmbs : 5,
                    u = "",
                    v = [],
                    w = {
                        icon: '<div id="{hash}" class="' + k + ' {permsclass} {dirclass} ui-corner-all" title="{tooltip}"><div class="elfinder-cwd-file-wrapper ui-corner-all"><div class="elfinder-cwd-icon {mime} ui-corner-all" unselectable="on" {style}/>{marker}</div><div class="elfinder-cwd-filename" title="{name}">{name}</div></div>',
                        row: '<tr id="{hash}" class="' + k + ' {permsclass} {dirclass}" title="{tooltip}"><td><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td></td><td>{date}</td><td>{size}</td></tr>'
                    },
                    x = b.res("tpl", "perms"),
                    y = b.res("tpl", "symlink"),
                    z = {
                        ...
                        marker: function(a) {
                            return (a.alias || a.mime == "symlink-broken" ? y : "") + (!a.read || !a.write ? x : "")
                        },
                        tooltip: function(a) {
                            var c = b.formatDate(a) + (a.size > 0 ? " (" + b.formatSize(a.size) + ")" : "");
                            return a.tooltip ? b.escape(a.tooltip).replace(/"/g, "&quot;").replace(/\r/g, "&#13;") + "&#13;" + c : c
                        }
                    },
                    A = function(a) {
                        return a.name = b.escape(a.name), w[d ? "row" : "icon"].replace(/\{([a-z]+)\}/g, function(b, c) {
                            return z[c] ? z[c](a) : a[c] ? a[c] : ""
                        })
                    },
                    B = !1,
                    C = function(b, c) {
                        function r(a, b) {
                            return a[b + "All"]("[id]:not(." + n + "):not(.elfinder-cwd-parent):first")
                        }
                        var e = a.ui.keyCode,
                            h = b == e.LEFT || b == e.UP,
                            i = W.find("[id]." + m),
                        ...
                        if (i.length) {
                            ...
                            if (!o.length) l = k;
                            else if (d || b == e.LEFT || b == e.RIGHT) l = o;
                            else {
                                p = k.position().top, q = k.position().left, l = k;
                                if (h) {
                                    do l = l.prev("[id]"); while (l.length && !(l.position().top < p && l.position().left <= q));
                                    l.is("." + n) && (l = r(l, "next"))
                                } else {
                                    do l = l.next("[id]"); while (l.length && !(l.position().top > p && l.position().left >= q));
                                    l.is("." + n) && (l = r(l, "prev")), l.length || (o = W.find("[id]:not(." + n + "):last"), o.position().top > p && (l = o))
                                }
                            }
                        } else l = W.find("[id]:not(." + n + "):not(.elfinder-cwd-parent):" + (h ? "last" : "first"));
                        l && l.length && !l.is(".elfinder-cwd-parent") && (c ? l = k.add(k[h ? "prevUntil" : "nextUntil"]("#" + l.attr("id"))).add(l) : i.trigger(g), l.trigger(f), J(l.filter(h ? ":first" : ":last")), I())
                    },
                    D = [],
                    E = function(a) {
                        W.find("#" + a).trigger(f)
                    ...
                    F = function() {
                        var c = b.cwd().hash;
                        W.find("[id]:not(." + m + "):not(.elfinder-cwd-parent)").trigger(f), D = a.map(b.files(), function(a) {
                            return a.phash == c ? a.hash : null
                        }), I()
                    },
                    G = function() {
                        D = [], W.find("[id]." + m).trigger(g), I()
                    },
                    H = function() {
                        return D
                    },
                    ...
                    J = function(a) {
                        var b = a.position().top,
                            ...
                            d = X.scrollTop(),
                            e = X.innerHeight();
                        b + c > d + e ? X.scrollTop(parseInt(b + c - e)) : b < d && X.scrollTop(b)
                    },
                    K = [],
                    L = function(a) {
                        var b = K.length;
                        while (b--)
                            if (K[b].hash == a) return b;
                        return -1
                    },
                    M = "scroll." + b.namespace,
                    N = function() {
                        var c = [],
                            e = !1,
                            g = [],
                            ...
                            i = W.find("[id]:last"),
                            j = !i.length,
                            k = d ? W.children("table").children("tbody") : W,
                            l;
                        if (!K.length) return X.unbind(M);
                        while ((!i.length || i.position().top <= X.height() + X.scrollTop() + b.options.showThreshold) && (l = K.splice(0, b.options.showFiles)).length) c = a.map(l, function(a) {
                            return a.hash && a.name ? (a.mime == "directory" && (e = !0), a.tmb && (a.tmb === 1 ? g.push(a.hash) : h[a.hash] = a.tmb), A(a)) : null
                        }), k.append(c.join("")), i = W.find("[id]:last"), j && W.scrollTop(0);
                        Q(h), g.length && R(g), e && P(), D.length && k.find("[id]:not(." + m + "):not(.elfinder-cwd-parent)").each(function() {
                            var b = this.id;
                            a.inArray(b, D) !== -1 && a(this).trigger(f)
                        })
                    },
                    O = a.extend({}, b.droppable, {
                        over: function(c, d) {
                            var e = b.cwd().hash;
                            a.each(d.helper.data("files"), function(a, c) {
                                if (b.file(c).phash == e) return W.removeClass(r), !1
                            })
                        }
                    }),
                    P = function() {
                        setTimeout(function() {
                            W.find(".directory:not(." + p + ",.elfinder-na,.elfinder-ro)").droppable(b.droppable)
                        }, 20)
                    },
                    Q = function(c) {
                    ...
                    R = function(a) {
                        ...
                        c = c = a.splice(0, t), c.length && b.request({
                            data: {
                                cmd: "tmb",
                                targets: c
                            },
                    ...
                    S = function(a) {
                        var c = d ? W.find("tbody") : W,
                            e = a.length,
                            f = [],
                            g = {},
                            h = !1,
                            i = function(a) {
                                var c = W.find("[id]:first"),
                                    d;
                                while (c.length) {
                                    d = b.file(c.attr("id"));
                                    if (!c.is(".elfinder-cwd-parent") && d && b.compare(a, d) < 0) return c;
                                    c = c.next("[id]")
                                }
                            },
                            j = function(a) {
                                var c = K.length,
                                    d;
                                for (d = 0; d < c; d++)
                                    if (b.compare(a, K[d]) < 0) return d;
                                return c || -1
                            },
                            k, l, m, n;
                        while (e--) {
                            k = a[e], l = k.hash;
                            if (W.find("#" + l).length) continue;
                            (m = i(k)) && m.length ? m.before(A(k)) : (n = j(k)) >= 0 ? K.splice(n, 0, k) : c.append(A(k)), W.find("#" + l).length && (k.mime == "directory" ? h = !0 : k.tmb && (k.tmb === 1 ? f.push(l) : g[l] = k.tmb))
                        }
                        Q(g), f.length && R(f), h && P()
                    },
                    T = function(a) {
                        var c = a.length,
                            d, e, f;
                        while (c--) {
                            d = a[c];
                            if ((e = W.find("#" + d)).length) try {
                                e.detach()
                            } catch (g) {
                                b.debug("error", g)
                            } else(f = L(d)) != -1 && K.splice(f, 1)
                        }
                    },
                    U = {
                        name: b.i18n("name"),
                    ...
                    V = function(e, f) {
                        ...
                        G();
                        try {
                            W.children("table," + l).remove()
                        } catch (h) {
                            W.html("")
                        }
                        W.removeClass("elfinder-cwd-view-icons elfinder-cwd-view-list").addClass("elfinder-cwd-view-" + (d ? "list" : "icons")), X[d ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list"), d && W.html('<table><thead><tr class="ui-state-default"><td >' + U.name + "</td><td>" + U.perm + "</td><td>" + U.mod + "</td><td>" + U.size + "</td><td>" + U.kind + "</td></tr></thead><tbody/></table>"), K = a.map(e, function(a) {
                            return f || a.phash == g ? a : null
                        }), K = b.sortFiles(K), X.bind(M, N).trigger(M), g = b.cwd().phash;
                        if (c.oldSchool && g && !u) {
                            var i = a.extend(!0, {}, b.file(g), {
                                name: "..",
                                mime: "directory"
                            });
                            i = a(A(i)).addClass("elfinder-cwd-parent").bind("mousedown click mouseup dblclick mouseenter", function(a) {
                                a.preventDefault(), a.stopPropagation()
                            }).dblclick(function() {
                                b.exec("open", this.id)
                            }), (d ? W.find("tbody") : W).prepend(i)
                        }
                    },
                    W = a(this).addClass("ui-helper-clearfix elfinder-cwd").attr("unselectable", "on").delegate(l, "click." + b.namespace, function(b) {
                        var c = this.id ? a(this) : a(this).parents("[id]:first"),
                            ...
                            i = e.length,
                            j;
                        b.stopImmediatePropagation(), b.shiftKey && (h || i) ? (j = h ? c.prevUntil("#" + d.attr("id")) : c.nextUntil("#" + e.attr("id")), j.add(c).trigger(f)) : b.ctrlKey || b.metaKey ? c.trigger(c.is("." + m) ? g : f) : (G(), c.trigger(f)), I()
                    }).delegate(l, "dblclick." + b.namespace, function(a) {
                        b.dblclick({
                            file: this.id
                        })
                    }).delegate(l, "mouseenter." + b.namespace, function(c) {
                        var e = a(this),
                            f = d ? e : e.children();
                        !e.is("." + s) && !f.is("." + o + ",." + n) && f.draggable(b.draggable)
                    }).delegate(l, f, function(b) {
                        var c = a(this),
                            d = c.attr("id");
                        !B && !c.is("." + n) && (c.addClass(m).children().addClass(q), a.inArray(d, D) === -1 && D.push(d))
                    }).delegate(l, g, function(b) {
                        var c = a(this),
                            d = c.attr("id"),
                            e;
                        B || (a(this).removeClass(m).children().removeClass(q), e = a.inArray(d, D), e !== -1 && D.splice(e, 1))
                    }).delegate(l, h, function() {
                        var b = a(this).removeClass(m).addClass(n),
                            c = (d ? b : b.children()).removeClass(q);
                        b.is("." + p) && b.droppable("disable"), c.is("." + o) && c.draggable("disable"), !d && c.removeClass(n)
                    }).delegate(l, i, function() {
                        var b = a(this).removeClass(n),
                            c = d ? b : b.children();
                        b.is("." + p) && b.droppable("enable"), c.is("." + o) && c.draggable("enable")
                    }).delegate(l, "scrolltoview", function() {
                        J(a(this))
                    }).delegate(l, "mouseenter mouseleave", function(c) {
                        b.trigger("hover", {
                            hash: a(this).attr("id"),
                            type: c.type
                        }), a(this).toggleClass("ui-state-hover")
                    }).bind("contextmenu." + b.namespace, function(c) {
                        var d = a(c.target).closest("." + k);
                        d.length && (c.stopPropagation(), c.preventDefault(), d.is("." + n) || (d.is("." + m) || (G(), d.trigger(f), I()), b.trigger("contextmenu", {
                            type: "files",
                            targets: b.selected(),
                            x: c.clientX,
                            y: c.clientY
                        ...
                        selected: function(b, c) {
                            a(c.selected).trigger(f)
                        },
                        unselected: function(b, c) {
                            a(c.unselected).trigger(g)
                        }
                    }).droppable(O).bind("create." + b.namespace, function(b, c) {
                        var e = d ? W.find("tbody") : W,
                            f = e.find(".elfinder-cwd-parent"),
                            c = a(A(c)).addClass(s);
                        G(), f.length ? f.after(c) : e.prepend(c), W.scrollTop(0)
                    }).bind("unselectall", G).bind("selectfile", function(a, b) {
                        W.find("#" + b).trigger(f), I()
                    }),
                    X = a('<div class="elfinder-cwd-wrapper"/>').bind("contextmenu", function(a) {
                    ...
                    Y = function() {
                        var b = 0;
                        X.siblings(".elfinder-panel:visible").each(function() {
                            b += a(this).outerHeight(!0)
                        }), X.height(_.height() - b)
                    },
                    Z = a(this).parent().resize(Y),
                    _ = Z.children(".elfinder-workzone").append(X.append(this));
                b.dragUpload && (X[0].addEventListener("dragenter", function(a) {
                    a.preventDefault(), a.stopPropagation(), X.addClass(r)
                }, !1), X[0].addEventListener("dragleave", function(a) {
                    a.preventDefault(), a.stopPropagation(), a.target == W[0] && X.removeClass(r)
                }, !1), X[0].addEventListener("dragover", function(a) {
                    a.preventDefault(), a.stopPropagation()
                }, !1), X[0].addEventListener("drop", function(a) {
                    a.preventDefault(), X.removeClass(r);
                    var c = !1,
                        d = "";
                    a.dataTransfer && a.dataTransfer.files && a.dataTransfer.files.length ? (c = a.dataTransfer.files, d = "files") : a.dataTransfer.getData("text/html") ? (c = [a.dataTransfer.getData("text/html")], d = "html") : a.dataTransfer.getData("text") && (c = [a.dataTransfer.getData("text")], d = "text"), c && b.exec("upload", {
                        files: c,
                        type: d
                    })
                }, !1)), b.bind("open", function(a) {
                    V(a.data.files)
                }).bind("search", function(a) {
                    v = a.data.files, V(v, !0)
                    ...
                    e != d && (d = e, V(b.files()), a.each(c, function(a, b) {
                        E(b)
                    }), I()), Y()
                }).add(function(c) {
                    var d = b.cwd().hash,
                        e = u ? a.map(c.data.added || [], function(a) {
                            return a.name.indexOf(u) === -1 ? null : a
                    ...
                    var d = b.cwd().hash,
                        e = b.selected(),
                        f;
                    u ? a.each(c.data.changed || [], function(b, c) {
                        T([c.hash]), c.name.indexOf(u) !== -1 && (S([c]), a.inArray(c.hash, e) !== -1 && E(c.hash))
                    }) : a.each(a.map(c.data.changed || [], function(a) {
                        return a.phash == d ? a : null
                    }), function(b, c) {
                        T([c.hash]), S([c]), a.inArray(c.hash, e) !== -1 && E(c.hash)
                    }), I()
                }).remove(function(a) {
                    T(a.data.removed || []), I()
                }).bind("open add search searchend", function() {
                    W.css("height", "auto"), W.outerHeight(!0) < X.height() && W.height(X.height() - (W.outerHeight(!0) - W.height()) - 2)
                }).dragstart(function(b) {
                    var c = a(b.data.target),
                        d = b.data.originalEvent;
                    c.is(l) && (c.is("." + m) || (!(d.ctrlKey || d.metaKey || d.shiftKey) && G(), c.trigger(f), I()), W.droppable("disable")), W.selectable("disable").removeClass(n), B = !0
                }).dragstop(function() {
                    W.selectable("enable").droppable("enable"), B = !1
                }).bind("lockfiles unlockfiles", function(a) {
                    var b = a.type == "lockfiles" ? h : i,
                        c = a.data.files || [],
                        d = c.length;
                    while (d--) W.find("#" + c[d]).trigger(b);
                    I()
                }).bind("mkdir mkfile duplicate upload rename archive extract", function(c) {
                    var d = b.cwd().hash,
                        e;
                    G(), a.each(c.data.added || [], function(a, b) {
                        b && b.phash == d && E(b.hash)
                    }), I()
                }).shortcut({
                    pattern: "ctrl+a",
                    ...
                    type: "keydown",
                    callback: function(a) {
                        C(a.keyCode, a.shiftKey)
                    }
                }).shortcut({
                    pattern: "home",
                    description: "selectffile",
                    callback: function(a) {
                        G(), J(W.find("[id]:first").trigger(f)), I()
                    }
                }).shortcut({
                    pattern: "end",
                    description: "selectlfile",
                    callback: function(a) {
                        G(), J(W.find("[id]:last").trigger(f)), I()
                    }
                })
            }), this
        }, a.fn.elfinderdialog = function(b) {
            var c;
            return typeof b == "string" && (c = this.closest(".ui-dialog")).length && (b == "open" ? c.css("display") == "none" && c.fadeIn(120, function() {
                c.trigger("open")
            }) : b == "close" ? c.css("display") != "none" && c.hide().trigger("close") : b == "destroy" ? c.hide().remove() : b == "toTop" && c.trigger("totop")), b = a.extend({}, a.fn.elfinderdialog.defaults, b), this.filter(":not(.ui-dialog-content)").each(function() {
                ...
                }), m.prepend(a('<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">' +
                    b.title + "</div>").prepend(a('<a href="#" class="ui-dialog-titlebar-close ui-corner-all"><span class="ui-icon ui-icon-closethick"/></a>').mousedown(function(a) {
            ...
            return this.each(function() {
                var d = [],
                    ...
                    x = a(this).addClass(b.res(e, "tree") + " elfinder-places ui-corner-all").hide().append(u).appendTo(b.getUI("navbar")).delegate("." + f, "mouseenter mouseleave", function() {
                        a(this).toggleClass("ui-state-hover")
            ...
            return this.each(function() {
                var c = !1,
                    ...
                    e = function() {
                        var d = a.trim(g.val());
                        d ? b.exec(d).done(function() {
                            c = !0, g.focus()
                        }) : b.fm.trigger("searchend")
                    },
                    f = function() {
                ...
                a('<span class="ui-icon ui-icon-search" title="' + b.title + '"/>').appendTo(d).click(e), a('<span class="ui-icon ui-icon-close"/>').appendTo(d).click(f), setTimeout(function() {
                    d.parent().detach(), b.fm.getUI("toolbar").prepend(d.show());
                    if (b.fm.UA.ltIE7) {
                        var a = d.children(b.fm.direction == "ltr" ? ".ui-icon-close" : ".ui-icon-search");
                        a.css({
                            right: "",
                            left: parseInt(d.width()) - a.outerWidth(!0)
                        })
                    }
            ...
            return this.each(function() {
                var c = b.fm,
                    ...
                    j = i + "-asc",
                    k = i + "-desc",
                    l = a(this).addClass("ui-state-default elfinder-button elfinder-menubutton elfiner-button-" + d).attr("title", b.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + d + '"/>').hover(function(a) {
                        !l.is("." + f) && l.toggleClass(g)
                    }).click(function(a) {
                        l.is("." + f) || (a.stopPropagation(), m.is(":hidden") && b.fm.getUI().click(), m.slideToggle(100))
                    }),
                    m = a('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>').hide().appendTo(l).zIndex(12 + l.zIndex()).delegate("." + h, "mouseenter mouseleave", function() {
                        a(this).toggleClass(g)
                    }).delegate("." + h, "click", function(a) {
                        a.preventDefault(), a.stopPropagation(), o()
                    }),
                    n = function() {
                        m.children(":not(:last)").removeClass(i + " " + j + " " + k).filter('[rel="' + c.sortType + '"]').addClass(i + " " + (c.sortOrder == "asc" ? j : k)), m.children(":last").toggleClass(i, c.sortStickFolders)
                    },
                    o = function() {
                        m.hide()
                    };
                a.each(c.sortRules, function(b, d) {
                    m.append(a('<div class="' + h + '" rel="' + b + '"><span class="ui-icon ui-icon-arrowthick-1-n"/><span class="ui-icon ui-icon-arrowthick-1-s"/>' + c.i18n("sort" + b) + "</div>").data("type", b))
                }), m.children().click(function(d) {
                    var e = a(this).attr("rel");
                    b.exec([], {
                        type: e,
                        order: e == c.sortType ? c.sortOrder == "asc" ? "desc" : "asc" : c.sortOrder,
                        stick: c.sortStickFolders
                    })
                }), a('<div class="' + h + " " + h + '-separated"><span class="ui-icon ui-icon-check"/>' + c.i18n("sortFoldersFirst") + "</div>").appendTo(m).click(function() {
                    b.exec([], {
                        type: c.sortType,
                        order: c.sortOrder,
                        stick: !c.sortStickFolders
                    })
                }), c.bind("disable select", o).getUI().click(o), c.bind("sortchange", n), m.children().length > 1 ? b.change(function() {
                    l.toggleClass(f, b.disabled()), n()
                }).change() : l.addClass(f)
            })
            ...
            return this.not(".elfinder-toolbar").each(function() {
                ...
                while (g--)
                    if (f[g]) {
                        ...
                        j.children().length && e.prepend(j), j.children(":gt(0)").before('<span class="ui-widget-content elfinder-toolbar-button-separator"/>')
                    }
            ...
            return this.not("." + d).each(function() {
                var e = "class",
                    ...
                    t = function(a) {
                        var b = K.offset().left;
                        return b <= a && a <= b + K.width()
                    },
                    u = b.droppable.drop,
                    v = a.extend(!0, {}, b.droppable, {
                        over: function(b) {
                            var c = a(this),
                                d = p + " " + o;
                            t(b.clientX) ? (c.addClass(d), c.is("." + j + ":not(." + k + ")") && setTimeout(function() {
                                c.is("." + o) && c.children("." + m).click()
                            }, 500)) : c.removeClass(d)
                        },
                        out: function() {
                        ...
                        drop: function(a, b) {
                            t(a.clientX) && u.call(this, a, b)
                        }
                    }),
                    w = a(b.res("tpl", "navspinner")),
                    x = b.res("tpl", "navdir"),
                    y = b.res("tpl", "perms"),
                    z = b.res("tpl", "symlink"),
                    A = {
                    ...
                    B = function(a) {
                        return a.name = b.escape(a.i18 || a.name), x.replace(/(?:\{([a-z]+)\})/ig, function(b, c) {
                    ...
                    D = function(a) {
                        return a ? J.find("#" + b.navHash2Id(a)).next("." + h) : J
                    },
                    E = function(c, d) {
                        var e = c.children(":first"),
                            f;
                        while (e.length) {
                            f = b.file(b.navId2Hash(e.children("[id]").attr("id")));
                            if ((f = b.file(b.navId2Hash(e.children("[id]").attr("id")))) && d.name.toLowerCase().localeCompare(f.name.toLowerCase()) < 0) return e;
                            e = e.next()
                        }
                        return a("")
                    },
                    F = function(a) {
                        ...
                        while (e--) {
                            f = a[e];
                            if (J.find("#" + b.navHash2Id(f.hash)).length) continue;
                            (h = D(f.phash)).length ? (g = B(f), f.phash && (i = E(h, f)).length ? i.before(g) : h[f.phash ? "append" : "prepend"](g)) : d.push(f)
                        }
                        if (d.length && d.length < c) return F(d);
                        setTimeout(function() {
                            H()
                        }, 10)
                    },
                    G = function(a) {
                        var d = b.cwd().hash,
                            e = J.find("#" + b.navHash2Id(d)),
                            j, m;
                        g && (j = J.find("#" + b.navHash2Id(b.root())), j.is("." + l) && j.addClass(k).next("." + h).show(), g = !1), e.is("." + n) || (J.find("." + i + "." + n).removeClass(n), e.addClass(n));
                        if (c.syncTree) {
                            if (e.length) return e.parentsUntil("." + f).filter("." + h).show().prev("." + i).addClass(k);
                            if (b.newAPI) {
                                m = b.file(d);
                                if (m && m.phash && J.find("#" + b.navHash2Id(m.phash)).length) return F([m]), G();
                                b.request({
                                    data: {
                                        cmd: "parents",
                                        target: d
                                    ...
                                    var c = C(a.tree);
                                    F(c), I(c, l), d == b.cwd().hash && G(!0)
                                })
                            }
                        }
                    },
                    H = function() {
                        J.find("." + i + ":not(." + s + ",.elfinder-ro,.elfinder-na)").droppable(v)
                    },
                    I = function(c, d) {
                        var e = d == l ? "." + j + ":not(." + l + ")" : ":not(." + j + ")";
                        a.each(c, function(c, f) {
                            J.find("#" + b.navHash2Id(f.phash) + e).filter(function() {
                                return a(this).next("." + h).children().length > 0
                            }).addClass(d)
                        })
                    },
                    J = a(this).addClass(d).delegate("." + i, "mouseenter mouseleave", function(c) {
                        var d = a(this),
                            e = c.type == "mouseenter";
                        ...
                        var d = a(this),
                            e = d.parent("." + i),
                            f = e.next("." + h);
                        c.stopPropagation(), e.is("." + l) ? (e.toggleClass(k), f.slideToggle()) : (w.insertBefore(d), e.removeClass(j), b.request({
                            cmd: "tree",
                            target: b.navId2Hash(e.attr("id"))
                        }).done(function(a) {
                            F(C(a.tree)), f.children().length && (e.addClass(j + " " + k), f.slideDown()), G()
                        }).always(function(a) {
                            w.remove(), e.addClass(l)
                        }))
                    ...
                    K = b.getUI("navbar").append(J).show();
                b.open(function(a) {
                    var b = a.data,
                        c = C(b.files);
                    b.init && J.empty(), c.length && (F(c), I(c, l)), G()
                }).add(function(a) {
                    var b = C(a.data.added);
                    b.length && (F(b), I(b, j))
                }).change(function(c) {
                    var d = C(c.data.changed),
                        e = d.length,
                        f, g, j, m, n, o, p, q, r;
                    while (e--) {
                        f = d[e];
                        if ((g = J.find("#" + b.navHash2Id(f.hash))).length) {
                            if (f.phash) {
                                m = g.closest("." + h), n = D(f.phash), o = g.parent().next(), p = E(n, f);
                                if (!n.length) continue;
                                if (n[0] !== m[0] || o.get(0) !== p.get(0)) p.length ? p.before(g) : n.append(g)
                            }
                            q = g.is("." + k), r = g.is("." + l), j = a(B(f)), g.replaceWith(j.children("." + i)), f.dirs && (q || r) && (g = J.find("#" + b.navHash2Id(f.hash))) && g.next("." + h).children().length && (q && g.addClass(k), r && g.addClass(l))
                        }
                    }
                    G(), H()
                }).remove(function(a) {
                    var c = a.data.removed,
                        d = c.length,
                        e, f;
                    while (d--)(e = J.find("#" + b.navHash2Id(c[d]))).length && (f = e.closest("." + h), e.parent().detach(), f.children().length || f.hide().prev("." + i).removeClass(j + " " + k + " " + l))
                }).bind("search searchend", function(a) {
                    J.find("#" + b.navHash2Id(b.cwd().hash))[a.type == "search" ? "removeClass" : "addClass"](n)
            ...
            this.shortcuts = [{
                ...
                }), d.state() == "rejected" ? d : d.resolve(c.clipboard(this.hashes(b)))
            }
            ...
            this.shortcuts = [{
                ...
                }), d.state() == "rejected" ? d : d.resolve(c.clipboard(this.hashes(b), !0))
            }
            ...
            this.shortcuts = [{
                ...
                var a = this.fm.selected(),
                    b = a.length;
                return !this._disabled && b && (!c.UA.IE || b == 1) && b == d(a).length ? 0 : -1
            }, this.exec = function(b) {
                var c = this.fm,
                    e = c.options.url,
                    f = d(b),
            ...
            this.disableOnSearch = !0, c.bind("open reload", function() {
                ...
                var a = this.files(a),
                    b = a.length;
                return !this._disabled && b && this.fm.cwd().write && e(a).length == b ? 0 : -1
            }, this.exec = function(b) {
                var e = this.files(b),
                    f = a.Deferred(),
                    g = e.length,
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [{
                ...
                }), o.push("</ul>"), a.inArray("about", d) !== -1 && r(), a.inArray("shortcuts", d) !== -1 && s(), a.inArray("help", d) !== -1 && t(), o.push("</div>"), u = a(o.join("")), b.one("load", function() {
                    u.find("#apiver").text(b.api)
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {
                ...
                var c = b.fm,
                    ...
                    f = function() {
                        var f = {
                                protocol: a("<select/>").change(function() {
                                    var a = this.value;
                                    h.find(".elfinder-netmount-tr").hide(), h.find(".elfinder-netmount-tr-" + a).show(), typeof e[a].select == "function" && e[a].select(c)
                                })
                            },
                            g = {
                                title: c.i18n("netMountDialogTitle"),
                                resizable: !1,
                                modal: !0,
                                destroyOnClose: !0,
                                close: function() {
                                    delete b.dialog, d.state() == "pending" && d.reject()
                                },
                                buttons: {}
                            },
                            h = a('<table class="elfinder-info-tb elfinder-netmount-tb"/>'),
                            i = a("<div/>");
                        return h.append(a("<tr/>").append(a("<td>" + c.i18n("protocol") + "</td>")).append(a("<td/>").append(f.protocol))), a.each(b.drivers, function(b, d) {
                            f.protocol.append('<option value="' + d + '">' + c.i18n(d) + "</option>"), a.each(e[d].inputs, function(b, e) {
                                e.attr("name", b), e.attr("type") != "hidden" ? (e.addClass("ui-corner-all elfinder-netmount-inputs-" + d), h.append(a("<tr/>").addClass("elfinder-netmount-tr elfinder-netmount-tr-" + d).append(a("<td>" + c.i18n(b) + "</td>")).append(a("<td/>").append(e)))) : (e.addClass("elfinder-netmount-inputs-" + d), i.append(e))
                            })
                        }), h.append(i), h.find(".elfinder-netmount-tr").hide(), f.protocol.change(), g.buttons[c.i18n("btnMount")] = function() {
                            var c = f.protocol.val(),
                                e = {
                                    cmd: "netmount",
                                    protocol: c
                                };
                            a.each(h.find("input.elfinder-netmount-inputs-" + c), function(b, c) {
                                var d;
                                typeof c.val == "function" ? d = a.trim(c.val()) : d = a.trim(c.value), d && (e[c.name] = d)
                            });
                            if (!e.host) return b.fm.trigger("error", {
                            ...
                            b.fm.request({
                                ...
                                d.reject(a)
                            }), b.dialog.elfinderdialog("close")
                        }, g.buttons[c.i18n("btnCancel")] = function() {
                            b.dialog.elfinderdialog("close")
                        }, c.dialog(h, g)
                    };
                return b.dialog || (b.dialog = f()), d.promise()
            }
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {
                ...
                var b = this.fm;
                return !!a && this.drivers.length && !this._disabled && b.file(a[0]).netkey ? 0 : -1
            }, this.exec = function(b) {
                var c = this,
                    d = this.fm,
                    e = a.Deferred().fail(function(a) {
                    ...
                    f = d.file(b[0]);
                return this._disabled ? e.reject() : (e.state() == "pending" && d.confirm({
                    title: c.title,
                    text: d.i18n("confirmUnmount", f.name),
                    accept: {
                        label: "btnUnmount",
                        callback: function() {
                            d.request({
            ...
            this.updateOnSelect = !1, this.handlers = {
                ...
                }), k.state() == "rejected" ? k : a.when(l(j), m(i)).always(function() {
                    g && d.clipboard([])
                })) : k.reject([h, e[0].name, "errPerm"])
            }
        }, elFinder.prototype.commands.pixlr = function() {
            this.updateOnSelect = !1, this.getstate = function(a) {
                var b = this.fm,
                    a = b.selectedFiles();
                return !this._disabled && a.length == 1 && a[0].read && a[0].mime.indexOf("image/") !== -1 && b.file(a[0].phash) && b.file(a[0].phash).write ? 0 : -1
            }, this.exec = function(b) {
                var c = this.fm,
                    d = a.Deferred().fail(function(a) {
                        a && c.error(a)
                    ...
                    g = function(a) {
                        var b, f, g, h;
                        b = e[0], g = c.uploadURL, g = g + (g.indexOf("?") === -1 ? "?" : "&") + "cmd=pixlr" + "&target=" + b.phash + "&node=" + encodeURIComponent(c.id), h = c.uploadURL, h = h + (h.indexOf("?") === -1 ? "?" : "&") + "cmd=pixlr", f = "http://pixlr.com/" + a + "/?image=" + encodeURIComponent(c.url(b.hash)) + "&target=" + encodeURIComponent(g) + "&title=" + encodeURIComponent("pixlr_" + b.name) + "&exit=" + encodeURIComponent(h);
                        if (!window.open(f)) return d.reject("errPopup")
                    },
                    h = a("<div/>"),
                    i = {
                ...
                return f ? (h.css("text-align", "center").append(a("<button/>").css("margin", "30px").append("Pixlr Editor").button().click(function() {
                    return g("editor"), a(this).elfinderdialog("destroy"), !1
                })).append(a("<button/>").css("margin", "30px").append("Pixlr Express").button().click(function() {
                    return g("express"), a(this).elfinderdialog("destroy"), !1
                })), dialog = c.dialog(h, i), d.resolve()) : d.reject()
            }
            ...
            this.resize = "resize." + c.namespace, this.info = a('<div class="elfinder-quicklook-info-wrapper"/>').append(s).append(t), this.preview = a('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change", function(a) {
                ...
                var c = b.window,
                    d = b.value,
                    h;
                b.closed() && d && (h = q.find("#" + d.hash)).length && (v.attr("style", ""), g = e, h.trigger("scrolltoview"), c.css(k(h)).show().animate(l(), 550, function() {
            ...
            var c = b.fm,
                ...
                e = b.preview,
                f = !1;
            c.UA.Safari && c.OS == "mac" || c.UA.IE ? f = !0 : a.each(navigator.plugins, function(b, c) {
                    ...
                    f = function(b, d) {
                        var f = a('<div class="elfinder-dialog-resize"/>'),
                            ...
                            z = a("input", y).change(function() {
                                ...
                                Y(), bb(!0), bc(!0), bd(!0), b == "resize" ? (o.show(), t.hide(), p.hide(), bb()) : b == "crop" ? (t.hide(), o.hide(), p.show(), bc()) : b == "rotate" && (o.hide(), p.hide(), t.show(), bd())
                            }),
                            ...
                            I = a('<div class="elfinder-resize-rotate-slider"/>').slider({
                                ...
                                animate: !0,
                                change: function(a, b) {
                                    b.value != I.slider("value") && ba.update(b.value)
                                },
                                slide: function(a, b) {
                                    ba.update(b.value, !1)
                                }
                            ...
                            T = a("<img/>").load(function() {
                                ...
                                Q = L * b, R = M * b, j.find("input,select").removeAttr("disabled").filter(":text").keydown(function(b) {
                                    ...
                                    c >= 48 && c <= 57 || c >= 96 && c <= 105 || b.preventDefault()
                            ...
                            ba = {
                                ...
                                imageBeingRotated: !1,
                                update: function(a, b) {
                                    typeof a == "undefined" && (S = a = parseInt(H.val())), typeof b == "undefined" && (b = !0), !b || c.UA.Opera || c.UA.ltIE8 ? X.rotate(a) : X.animate({
                                        rotate: a + "deg"
                                    }), a %= 360, a < 0 && (a += 360), H.val(parseInt(a)), I.slider("value", H.val())
                                },
                                execute: function(a) {
                                    if (!ba.imageBeingRotated) return;
                                    var b = ba.getCenter(X),
                                        c = a.pageX - b[0],
                                        d = a.pageY - b[1],
                                        e = Math.atan2(d, c),
                                        f = e - ba.mouseStartAngle + ba.imageStartAngle;
                                ...
                                start: function(b) {
                                    ba.imageBeingRotated = !0;
                                    var c = ba.getCenter(X),
                                        d = b.pageX - c[0],
                                        e = b.pageY - c[1];
                                    return ba.mouseStartAngle = Math.atan2(e, d), ba.imageStartAngle = parseFloat(X.rotate()) * Math.PI / 180, a(document).mousemove(ba.execute), !1
                                },
                                stop: function(b) {
                                    if (!ba.imageBeingRotated) return;
                                    return a(document).unbind("mousemove", ba.execute), setTimeout(function() {
                                        ba.imageBeingRotated = !1
                                    }, 10), !1
                                },
                            ...
                            bb = function(b) {
                                a.fn.resizable && (b ? (m.filter(":ui-resizable").resizable("destroy"), m.hide()) : (m.show(), m.resizable({
                                    alsoResize: T,
                                    aspectRatio: N,
                                    resize: Z.update,
                                    stop: Z.fixHeight
                            ...
                            bc = function(b) {
                                a.fn.draggable && a.fn.resizable && (b ? (n.filter(":ui-resizable").resizable("destroy"), n.filter(":ui-draggable").draggable("destroy"), U.hide()) : (V.width(T.width()).height(T.height()), W.width(T.width()).height(T.height()), n.width(V.width()).height(V.height()).offset(V.offset()).resizable({
                                    containment: U,
                        ...
                        X.mousedown(ba.start), a(document).mouseup(ba.stop), o.append(a(h).append(a(i).text(c.i18n("width"))).append(B).append(x)).append(a(h).append(a(i).text(c.i18n("height"))).append(C)).append(a(h).append(a("<label/>").text(c.i18n("aspectRatio")).prepend(A))).append(a(h).append(c.i18n("scale") + " ").append(w)), p.append(a(h).append(a(i).text("X")).append(D)).append(a(h).append(a(i).text("Y")).append(E)).append(a(h).append(a(i).text(c.i18n("width"))).append(F)).append(a(h).append(a(i).text(c.i18n("height"))).append(G)), t.append(a(h).append(a(i).text(c.i18n("rotate"))).append(a('<div style="float:left; width: 130px;">').append(a('<div style="float:left;">').append(H).append(a("<span/>").text(c.i18n("degree")))).append(a(q).append(u).append(a(s)).append(v))).append(I)), f.append(y), j.append(a(h)).append(o).append(p.hide()).append(t.hide()).find("input,select").attr("disabled", "disabled"), m.append('<div class="' + bg + " " + bg + '-top"/>').append('<div class="' + bg + " " + bg + '-bottom"/>').append('<div class="' + bh + " " + bh + '-left"/>').append('<div class="' + bh + " " + bh + '-right"/>').append('<div class="' + bi + " " + bi + '-e"/>').append('<div class="' + bi + " " + bi + '-se"/>').append('<div class="' + bi + " " + bi + '-s"/>'), k.append(l).append(m.hide()).append(T.hide()), n.css("position", "absolute").append('<div class="' + bg + " " + bg + '-top"/>').append('<div class="' + bg + " " + bg + '-bottom"/>').append('<div class="' + bh + " " + bh + '-left"/>').append('<div class="' + bh + " " + bh + '-right"/>').append('<div class="' + bi + " " + bi + '-n"/>').append('<div class="' + bi + " " + bi + '-e"/>').append('<div class="' + bi + " " + bi + '-s"/>').append('<div class="' + bi + " " + bi + '-w"/>').append('<div class="' + bi + " " + bi + '-ne"/>').append('<div class="' + bi + " " + bi + '-se"/>').append('<div class="' + bi + " " + bi + '-sw"/>').append('<div class="' + bi + " " + bi + '-nw"/>'), k.append(U.css("position", "absolute").hide().append(V).append(n.append(W))), k.append(X.hide()), k.css("overflow", "hidden"), f.append(k).append(j), bf[c.i18n("btnCancel")] = function() {
                        ...
                        }).attr("id", d), c.UA.ltIE8 && a(".elfinder-dialog").css("filter", ""), x.css("left", B.position().left + B.width() + 12), W.css({
                            opacity: .2,
                            ...
                            opacity: .5,
                            "border-color": "#000"
                        }), X.css("cursor", "pointer"), y.buttonset(), O = k.width() - (m.outerWidth() - m.width()), P = k.height() - (m.outerHeight() - m.height()), T.attr("src", bj + (bj.indexOf("?") === -1 ? "?" : "&") + "_=" + Math.random()), V.attr("src", T.attr("src")), X.attr("src", T.attr("src"))
                    },
                    g, h;
        ...
        function(a) {
            ...
            }, a.fn.rotate = function(a) {
                if (typeof a == "undefined") {
                    if (!window.opera) {
                        var b = this.css("transform").match(/rotate\((.*?)\)/);
                        return b && b[1] ? parseInt(b[1]) : 0
                    }
                    var b = this.css("transform").match(/rotate\((.*?)\)/);
                    return b && b[1] ? Math.round(parseFloat(b[1]) * 180 / Math.PI) : 0
                }
                return this.css("transform", this.css("transform").replace(/none|rotate\(.*?\)/, "") + "rotate(" + parseInt(a) + "deg)"), this
            ...
            this.shortcuts = [{
                ...
                }), e.state() == "pending" && (f = this.hashes(b), d.confirm({
                    title: c.title,
                    text: "confirmRm",
                    accept: {
                        label: "btnRm",
            ...
            this.options = {
                ...
                var d = this.fm,
                    c = a.extend({
                        type: d.sortType,
                        order: d.sortOrder,
                        stick: d.sortStickFolders
                    }, c);
                return this.fm.setSort(c.type, c.order, c.stick), a.Deferred().resolve()
            }
            ...
            this.disableOnSearch = !0, this.updateOnSelect = !1, this.shortcuts = [{
                ...
                return this.disabled() ? a.Deferred().reject() : c && (c.input || c.files) ? d.upload(c) : (f = a.Deferred(), h = a('<input type="file" multiple="true"/>').change(function() {
                    ...
                    i.toggleClass(b)
                }), g = a('<div class="elfinder-upload-dialog-wrapper"/>').append(i), k = a('<div class="ui-corner-all elfinder-upload-dropbox" contenteditable=true></div>').focus(function() {
                    if (this.innerHTML) {
                        var a = this.innerHTML.replace(/<br[^>]*>/gi, " "),
                            b = a.match(/<[^>]+>/) ? "html" : "text";
                        this.innerHTML = "", e({
                            files: [a],
                            type: b
                    ...
                    this.focus(), a(k).addClass(b)
                }).bind("dragleave mouseout", function() {
                    this.blur(), a(k).removeClass(b)
                }).bind("mouseup keyup", function() {
                    setTimeout(function() {
                        a(k).focus()
                    }, 100)
                }), d.dragUpload ? (j = a('<div class="ui-corner-all elfinder-upload-dropbox">' + d.i18n("dropFiles") + "</div>").prependTo(g).after('<div class="elfinder-upload-dialog-or">' + d.i18n("or") + "</div>").after(k).after("<div>" + d.i18n("dropFilesBrowser") + "</div>").after('<div class="elfinder-upload-dialog-or">' + d.i18n("or") + "</div>")[0], j.addEventListener("dragenter", function(c) {
                ...
                }, !1), j.addEventListener("dragover", function(c) {
                    c.stopPropagation(), c.preventDefault(), a(j).addClass(b)
                }, !1), j.addEventListener("drop", function(a) {
                    a.stopPropagation(), a.preventDefault();
                    var b = !1,
                        c = "";
                    a.dataTransfer && a.dataTransfer.files && a.dataTransfer.files.length ? (b = a.dataTransfer.files, c = "files") : a.dataTransfer.getData("text/html") ? (b = [a.dataTransfer.getData("text/html")], c = "html") : a.dataTransfer.getData("text") && (b = [a.dataTransfer.getData("text")], c = "text"), b && e({
                        files: b,
                        type: c
                    })
                }, !1)) : a("<div>" + d.i18n("dropFilesBrowser") + "</div>").append(k).prependTo(g).after('<div class="elfinder-upload-dialog-or">' + d.i18n("or") + "</div>")[0], d.dialog(g, {
                    title: this.title,
                    modal: !0,
                    resizable: !1,
                    destroyOnClose: !0
